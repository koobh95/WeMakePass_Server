...
public class MailServiceImpl implements MailService{
	private final UserCertRepository accountCertRepository;
	...
	public void sendAccountCertMail(String userId) {
		...
		Optional<UserCert> accountCert = accountCertRepository.findById(userId);
		accountCert.ifPresentOrElse(e -> e.updateCode(code),
				() -> accountCertRepository.save(
	...
	public void confirm(String userId, String code) {
		UserCert accountCert = accountCertRepository.findById(userId).get();
		if(!accountCert.getCode().equals(code))
